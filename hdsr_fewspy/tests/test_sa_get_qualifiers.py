...
def test_sa_qualifiers_json(fixture_api_sa_no_download_dir):
    response = fixture_api_sa_no_download_dir.get_qualifiers(output_choice=OutputChoices.xml_response_in_memory)
